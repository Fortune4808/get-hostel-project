...
<link href="<?php echo $website_url ?>/admin/portal/all-images/image-pix/icon.png" rel="shortcut icon" type="image-png" />
<link href="<?php echo $website_url ?>/admin/portal/src/styles/output.css?v=<?php echo $latest_version;?>" rel="stylesheet">
...
<script src="<?php echo $website_url ?>/admin/portal/src/js/scripts.js?v=<?php echo $latest_version;?>" type="text/javascript"></script>
